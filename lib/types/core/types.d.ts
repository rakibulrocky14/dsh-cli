...
export declare function service<T>(ctx: DshContext, name: string): T | undefined;
/** True when `value` is an object with a callable `method`. */
export declare function hasMethod(value: unknown, method: string): value is Record<string, (...args: never[]) => unknown>;
/** Read the durable log across releases (events snapshot, else indexed read). */
export declare function readSessionEvents(session: DshSession): readonly SessionEvent[];
