...
export function Banner({ model, effort, cwd, recent, width = MAX_CONTENT }: {
  ...
  return (
    <Box borderStyle="round" borderColor={theme.accent} paddingX={1} paddingY={1} width={boxWidth} flexDirection="row" marginTop={1} marginBottom={1}>
      <Box flexDirection="column" width={leftWidth} marginRight={1} alignItems="center">
        {WHALE.map((line, i) => (
      ...
      <Box flexDirection="column" width={rightWidth} justifyContent="center">
        ...
        <Box marginTop={1} flexDirection="column">
          ...
          {BANNER_TIPS.map(t => <Text key={t} dimColor>{clipWidth(t, rightWidth)}</Text>)}
        </Box>
        <Box marginTop={1} flexDirection="column">
